...
<html lang="en">
    <head>
        ...
        <title>Green Coffer-order detail page</title>
    </head>
    <body>
            ...
            <section class="order-detail">
                ...
                <div class="box-container">
                  ...
                  if($select_orders->rowCount()>0){
                    while($fetch_order=$select_orders->$fetch_order(PDO::FETCH_ASSOC)){
                            ...
                            while($fetch_product=$select_product->fetch(PDO::FETCH_ASSOC)){
                                ...
                                <div class="box">
                                    ...
                                    <div class="col">
                                        ...
                                        'green';}elseif($fetch_order['status']=='canceld'){echo 'red';}else{echo '
                                            orange';}?>"><?=$fetch_order['status']?></p>
                                           <?php 
                                              if ($fetch_order['status'] == 'canceld') { ?>
