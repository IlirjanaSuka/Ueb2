    ...
    <div class="box">
      ...
      <img src="img/ave.png">
        ...
        <section class="shop">
            ...
            <div class="box-container">
                <div class="box">
                    <img src="img/knzfkegneolokoyhldtb.webp">
                    <a href="view_products.php" class="btn">shop now</a>
                </div>
                <div class="box">
                    <img src="img/32.jpg">
                ...
                <div class="box">
                    <img src="img/dfcawc79kcwkj4utj4sm_525x525.webp">
                    <a href="view_products.php" class="btn">shop now</a>
                </div>
                <div class="box">
                    <img src="img/128163-1-400.webp">
                    <a href="view_products.php" class="btn">shop now</a>
                </div>
                <div class="box">
                ...
                <div class="box">
                    <img src="img/Green-Coffee-Extracts.jpg">
                    <a href="view_products.php" class="btn">shop now</a>
                </div>
            </div>
        </section>
            ...
            <div class="box-container">
                <div class="box">
                    ...
                    <div class="detail">
                        ...
                        <h1>Extra 15% off</h1>
                        <a href="view_produtc.php"class="btn">shop now</a>
                    </div>
                </div>
                <div class="box">
                    <img src="img/612.jpg">
